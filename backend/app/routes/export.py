...
EXCEL_COLUMNS = [
    ...
    ('predicted_score', 'Prediksi Nilai Raport'),
...
def _student_variable_rows(report: dict[str, Any]):
    ...
    return [
        ...
        ['Prediksi Nilai Raport', _format_value(prediction.predicted_exam_score)],
...
def _analytics_dashboard_rows():
    ...
    for student in students:
        ...
        rows.append({
            ...
            'risk_status': prediction.risk_status if prediction else None,
            'latest_prediction': {
                'predicted_nilai_raport': prediction.predicted_exam_score if prediction else None,
                'risk_status': prediction.risk_status if prediction else None,
