        ...
        <table className="w-full">
          ...
          <tbody>
            ...
            <tr className="grid grid-cols-7">
              <td className="ease relative h-20 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray-2 md:h-25 md:p-6 xl:h-31 dark:border-dark-3 dark:hover:bg-dark-2">
                ...
                <div className="group h-16 w-full grow cursor-pointer py-1 md:h-30">
                  ...
                  <div className="event invisible absolute left-2 z-99 mb-1 flex w-[200%] flex-col rounded-r-[5px] border-l-[3px] border-primary bg-gray-2 px-3 py-1 text-left opacity-0 group-hover:visible group-hover:opacity-100 md:visible md:w-[190%] md:opacity-100 dark:bg-dark-2">
            ...
            <tr className="grid grid-cols-7">
              ...
              <td className="ease relative h-20 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray-2 md:h-25 md:p-6 xl:h-31 dark:border-dark-3 dark:hover:bg-dark-2">
                ...
                <div className="group h-16 w-full grow cursor-pointer py-1 md:h-30">
                  ...
                  <div className="event invisible absolute left-2 z-99 mb-1 flex w-[300%] flex-col rounded-r-[5px] border-l-[3px] border-primary bg-gray-2 px-3 py-1 text-left opacity-0 group-hover:visible group-hover:opacity-100 md:visible md:w-[290%] md:opacity-100 dark:bg-dark-2">
                    <span className="event-name font-medium text-dark dark:text-white">
                      App Design
                    </span>
            ...
            {/* <!-- Line 5 --> */}
            <tr className="grid grid-cols-7">
              <td className="ease relative h-20 cursor-pointer rounded-bl-[10px] border border-stroke p-2 transition duration-500 hover:bg-gray-2 md:h-25 md:p-6 xl:h-31 dark:border-dark-3 dark:hover:bg-dark-2">
                <span className="font-medium text-dark dark:text-white">
                  29
                </span>
              </td>
              ...
              <td className="ease relative h-20 cursor-pointer rounded-br-[10px] border border-stroke p-2 transition duration-500 hover:bg-gray-2 md:h-25 md:p-6 xl:h-31 dark:border-dark-3 dark:hover:bg-dark-2">
                <span className="font-medium text-dark dark:text-white">4</span>
              </td>
            </tr>
            {/* <!-- Line 5 --> */}
