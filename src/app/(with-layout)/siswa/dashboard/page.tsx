...
export default async function SiswaDashboardPage() {
  ...
  const menuCards = [
    {
      ...
      description:
        "Lihat hasil prediksi performa belajarmu berdasarkan data terbaru.",
      href: "/siswa/prediksi",
    ...
    },
    {
      ...
      title: "Insight SHAP",
      description:
        "Analisis faktor-faktor yang paling mempengaruhi performamu.",
      href: "/siswa/insight",
    ...
    },
    {
      ...
      title: "Update Data",
      description:
        "Perbarui data belajarmu untuk mendapatkan prediksi yang akurat.",
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 space-y-6 duration-500 ease-out">
        ...
        <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="text-white">
            ...
            <p className="max-w-md text-sm leading-relaxed text-white/85">
              Selamat datang kembali di dashboard pembelajaran kamu. Pantau
              perkembangan dan dapatkan insight personal di sini.
            </p>
          </div>
      ...
      <section className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {menuCards.map((card) => {
          ...
          return (
            ...
            >
              <div
                className={`pointer-events-none absolute -top-8 -right-8 h-28 w-28 rounded-full blur-2xl transition-all duration-300 group-hover:scale-125 ${card.colorBlur}`}
              />
              <div
      ...
      {/* ── Quick Action Banner ── */}
      <section className="flex flex-col items-start justify-between gap-4 rounded-2xl border border-primary/20 bg-primary/5 p-6 sm:flex-row sm:items-center dark:border-primary/30 dark:bg-primary/10">
