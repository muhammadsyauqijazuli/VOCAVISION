    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 space-y-6 duration-500 ease-out">
      ...
      <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-indigo-500 to-blue-dark p-8 shadow-1 md:p-10">
        ...
        <div className="relative z-10 flex flex-col gap-5 sm:flex-row sm:items-center">
          {/* Avatar */}
          <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-white/20 text-3xl font-bold text-white ring-2 ring-white/30 backdrop-blur-md">
            {initials}
          </div>
          ...
          <div className="text-white">
            ...
            <span className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-white/20 px-3 py-1 text-xs font-semibold text-white capitalize backdrop-blur-sm">
              <FiShield size={11} />
              {user.role}
            </span>
          </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <section className="flex flex-col gap-4">
          <div className="rounded-2xl border border-stroke bg-white p-6 shadow-1 dark:border-dark-3 dark:bg-gray-dark">
            <h2 className="mb-4 font-bold text-dark dark:text-white">
              Aksi Cepat
            </h2>
          ...
          <div className="rounded-2xl border border-primary/20 bg-primary/5 p-5 dark:border-primary/30 dark:bg-primary/10">
            ...
            <p className="mt-2 text-sm text-dark-4 dark:text-dark-6">
              ...
              <span className="font-semibold text-dark capitalize dark:text-white">
                {user.role}
              </span>
              . Semua data yang kamu lihat bersifat personal dan hanya bisa
              diakses oleh kamu.
            </p>
          </div>
        </section>
